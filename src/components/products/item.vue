    ...
    <dl class="s-item">
        ...
        <dd>
            ...
            <p >
                ...
                <span v-else-if="meta.score > 3.5">好</span>
                <span v-else-if="meta.score > 2.5">不错</span>
                <span v-else>一般</span>
            ...
            <p><span class="s-item-price">人均￥{{meta.avgPrice}}</span></p>
            <ul class="deal-items">
                <li class="items" v-for="(item,index) in meta.dealItems.slice(0,2)" :key="index">
                    ...
                    <p>
                        ...
                        <span class="deal-seles">已售{{item.saleNum}}</span>
